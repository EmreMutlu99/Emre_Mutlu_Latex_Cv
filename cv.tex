...
\name{Ömer Emre}{Mutlu}
\tagline{Lead Software \& Embedded Systems Engineer}
\photo{4cm}{EmreMutlu-photo}
\socialinfo{
	\github{EmreMutlu99}
	\smartphone{(+49) 17631334814}
	\email{emre.mutlu@sagel-ai.com}\\
	\address{Hubertusstraße 1-5, 52477 Alsdorf, Germany}\\
	\infos{German work permit · Turkish nationality · Born 08 Jul 1999 (Istanbul)}
}
\begin{document}
